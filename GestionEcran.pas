...
interface
    ...
    // supprime tous les caract�res de l'�cran mais ne change pas les couleurs
    // de fond
    ...
    // supprime tous les caract�res de l'�cran et colorie le fond dans la couleur
    // d�sir�e (cette couleur est gard�e comme couleur de fond par d�faut et la
    // couleur du texte est conserv�e)
    ...
    procedure attendrems(millisecondes : integer);
...
implementation
    ...
    begin
      ...
      // on dessine les lignes interm�diaires
